...
<div class="container-fluid py-4">
    <div class="row">
        ...
        <div class="col-12 text-center mb-4">
            <h1 class="h3 fw-bold">College Course Quiz Assessment</h1>
        ...
        <div class="col-12 col-lg-7 mb-4 mb-lg-0">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body">
                    <form id="quizForm" action="{{ route('college.quiz.submit') }}" method="POST">
                        @csrf

                        @php
                            $questions = json_decode(file_get_contents(public_path('data/college_quiz_questions.json')), true);
                        @endphp
