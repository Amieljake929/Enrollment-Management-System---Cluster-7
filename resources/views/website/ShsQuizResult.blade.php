    ...
    <div class="max-w-4xl mx-auto">
                    ...
                    @foreach($recommendations as $idx => $rec)
                        <div class="mb-4 p-3 border rounded @if($rec['is_top']) bg-light border-primary @endif">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <h3 class="h5 mb-1">{{ $rec['strand'] }}</h3>
            ...
            <div class="card shadow-sm border-0 mb-6">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3">
                        Scores based on your responses (3 = Very Interested, 2 = Interested, 1 = Slight, 0 = Not)
                    </p>
            ...
            <div class="card shadow-sm border-0 mb-6">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-light border mt-4">
                        ...
                        <p class="mb-0 small">
                            <strong>Top Match:</strong> {{ $recommendations[0]['strand'] }} |
        ...
        @else
            ...
            <div class="text-center p-5 bg-light border rounded mb-6">
                ...
                <p class="text-muted">We couldn't determine a clear strand based on your answers.</p>
        ...
        <div class="text-center mt-4">
            <a href="{{ route('quiz.show') }}" class="btn btn-primary btn-lg px-5">
                Take Quiz Again
            </a>
        </div>
    </div>
