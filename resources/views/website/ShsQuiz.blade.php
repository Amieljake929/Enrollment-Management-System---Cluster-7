        ...
        <div class="col-md-10">
            <div class="card shadow-lg border-0 rounded-4" style="background: #f8f9fa;">
                <div class="card-header bg-white border-bottom-0 p-4">
                    <h4 class="text-primary fw-bold mb-0">📝 SHS Strand Quiz Assessment</h4>
                    ...
                    <form id="quizForm" method="POST" action="{{ route('quiz.submit') }}">
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="text-primary fw-bold"><i class="fas fa-lightbulb me-2"></i> SHS Strand Assessment</span>
                                    ...
                                    @foreach($strandQuestions as $q)
                                        @if($q['type'] === 'regular')
                                            <div class="question-card mb-4 p-4 bg-white border rounded shadow-sm" data-question-id="{{ $q['id'] }}" style="display: {{ $currentQuestionIndex == 0 ? 'block' : 'none' }};">
                                                <h5 class="mb-3">{{ $q['question'] }}</h5> <!-- ❌ WALANG NUMBER -->
                                                <div class="row g-3">
                                                    <div class="col-12">
                                    ...
                                    <div class="question-card mb-4 p-4 bg-white border rounded shadow-sm" data-question-id="{{ $q['id'] }}" style="display: none;">
                                        ...
                                        <div class="row g-3">
                                            @foreach($q['options'] as $opt)
                                                <div class="col-12">
                                                    <div class="form-check p-3 border rounded d-flex align-items-center" style="cursor: pointer;">
                                                        <input class="form-check-input me-3" type="radio" name="answers[{{ $q['id'] }}]" value="{{ $opt['strand'] }}" id="tb{{ $q['id'] }}_{{ $opt['label'] }}" required>
