...
<head>
    <meta charset="utf-8">
    <title>Waiting SHS Admissions Report</title>
    <style>
        body {
...
<body>
    ...
    <div class="report-title">
        Waiting SHS Admissions Report (Validated)
    </div>
    ...
    @if($students->isEmpty())
        <p class="no-data">No waiting SHS admissions found.</p>
    @else
        <table>
            <thead>
                <tr>
