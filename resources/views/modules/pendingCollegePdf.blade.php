...
<head>
    <meta charset="utf-8">
    <title>Pending College Admissions Report</title>
    <style>
...
<body>
    <div class="header">
        <h2>Pending College Admissions Report</h2>
        <div class="meta">
    ...
    @if($students->isEmpty())
        <p style="text-align: center; margin-top: 30px;">No pending college admissions found.</p>
    @else
        <table>
            <thead>
                <tr>
