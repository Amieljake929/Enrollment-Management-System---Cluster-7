...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('modules.waiting.shs.download.pdf', request()->query()) }}"
    ...
    <button type="button" class="btn btn-sm btn-primary view-shs-student"
...
document.addEventListener('click', function(e) {
    const viewBtn = e.target.closest('.view-shs-student');
    if (viewBtn) {
        e.preventDefault();
        ...
        fetch(`/modules/waiting/shs/${studentId}`)
