...
document.addEventListener('click', function(e) {
    ...
    if (link) {
        ...
        // Fetch student data - Use staff route
    ...
    return `
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <p><strong>Enrollee Number:</strong> ${student.enrolleeNumber ? student.enrolleeNumber.enrollee_no : 'N/A'}</p>
            </div>
            <div class="col-md-6">
                <h6 class="fw-bold">Educational Background</h6>
                ${student.educationalBackground ? `
                    <p><strong>Primary School:</strong> ${student.educationalBackground.primary_school || 'N/A'}</p>
                    <p><strong>Primary Year Graduated:</strong> ${student.educationalBackground.primary_year_graduated || 'N/A'}</p>
                    <p><strong>Secondary School:</strong> ${student.educationalBackground.secondary_school || 'N/A'}</p>
                    <p><strong>Secondary Year Graduated:</strong> ${student.educationalBackground.secondary_year_graduated || 'N/A'}</p>
                    <p><strong>Last School Attended:</strong> ${student.educationalBackground.last_school_attended || 'N/A'}</p>
                    <p><strong>Last School Year Graduated:</strong> ${student.educationalBackground.last_school_year_graduated || 'N/A'}</p>
...
document.addEventListener('click', function(e) {
    ...
    if (validateBtn) {
        ...
        fetch(`/staff/modules/pending/college/${studentId}/validate`, {
            method: 'POST',
            headers: {
...
document.addEventListener('click', function(e) {
    ...
    if (cancelBtn) {
        ...
        fetch(`/staff/modules/pending/college/${studentId}/cancel`, {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'X-Requested-With': 'XMLHttpRequest'
...
document.addEventListener('click', function(e) {
    ...
    if (reevaluateBtn) {
        ...
        fetch(`/staff/modules/pending/college/${studentId}/reevaluate`, {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'X-Requested-With': 'XMLHttpRequest'
