...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        {{-- <a href="{{ route('staff.modules.reevaluation.shs.download.pdf', request()->query()) }}"
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-body p-4">
            <form method="GET" action="{{ route('staff.modules.reevaluation.shs') }}" class="row g-3">
                <div class="col-md-3">
...
document.addEventListener('click', function(e) {
    ...
    if (viewBtn) {
        ...
        `;
        modal.show();
        fetch(`/staff/modules/pending/shs/${studentId}`)
...
document.addEventListener('click', function(e) {
    ...
    if (btn) {
        ...
        fetch(`/staff/modules/pending/shs/${id}/validate`, {
            method: 'POST',
            headers: {
...
document.addEventListener('click', function(e) {
    ...
    if (btn) {
        ...
        fetch(`/staff/modules/pending/shs/${id}/cancel`, {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                'X-Requested-With': 'XMLHttpRequest'
