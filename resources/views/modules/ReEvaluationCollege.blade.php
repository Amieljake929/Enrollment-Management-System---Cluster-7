<!-- resources/views/modules/ReEvaluationCollege.blade.php -->
@extends('layouts.app')
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        {{-- <a href="{{ route('modules.reevaluation.college.download.pdf', request()->query()) }}" 
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-body p-4">
            <form method="GET" action="{{ route('modules.reevaluation.college') }}" class="row g-3">
                <div class="col-md-3">
...
document.addEventListener('click', function(e) {
    ...
    if (btn) {
        ...
        fetch(`/modules/pending/college/${id}/validate`, {
            method: 'POST',
            headers: {
...
document.addEventListener('click', function(e) {
    ...
    if (btn) {
        ...
        fetch(`/modules/pending/college/${id}/cancel`, {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                'X-Requested-With': 'XMLHttpRequest'
