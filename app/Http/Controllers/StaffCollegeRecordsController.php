...
class StaffCollegeRecordsController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Support for AJAX requests (Sidebar clicks)
        if ($request->ajax()) {
            return view('modules.staff.recordsCollege', compact('courses', 'groupedData'))->render();
        }

        return view('modules.staff.recordsCollege', compact('courses', 'groupedData'));
    }
}