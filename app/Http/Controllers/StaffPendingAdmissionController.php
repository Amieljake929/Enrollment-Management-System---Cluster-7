...
class StaffPendingAdmissionController extends Controller
{
    /**
  ...
  public function index(Request $request)
{
    ...
    if ($request->ajax()) {
        return view('modules.staff.pendingCollege', compact('students','studentTypes'))->render();
    }

    return view('modules.staff.pendingCollege', compact('students','studentTypes'));
}
    ...
    public function shsIndex(Request $request)
{
    ...
    if ($request->ajax()) {
        return view('modules.staff.pendingShs', compact('students','studentTypes'))->render();
    }

    return view('modules.staff.pendingShs', compact('students','studentTypes'));
}
