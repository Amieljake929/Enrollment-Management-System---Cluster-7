...
class StaffCancelledController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('modules.staff.cancelledCollege', compact('students', 'studentTypes'));
    }
    ...
    public function shsIndex(Request $request)
    {
        ...
        return view('modules.staff.cancelledShs', compact('students', 'studentTypes'));
    }
