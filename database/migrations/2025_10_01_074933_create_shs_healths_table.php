...
return new class extends Migration
{
     ...
     * Run the migrations.
     */
    // database/migrations/xxxx_xx_xx_create_shs_health_info_table.php
public function up()
{
    Schema::create('shs_health_info', function (Blueprint $table) {
        $table->id();
        $table->unsignedBigInteger('student_id');
        $table->string('condition')->nullable(); // for "Others"
